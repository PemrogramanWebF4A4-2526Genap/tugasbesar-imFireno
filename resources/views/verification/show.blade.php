        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    @endif
                    <form class="space-y-4 md:space-y-6" method="post" action="/verify/{{$unique_id}}">
                        @method('PUT')
                        @csrf
                        @error('otp')
                        ...
                        <div>
                            <label for="email"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your OTP</label>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Don't have account yet? <a href="/register"
                                class="font-medium text-teal-600 hover:underline dark:text-teal-500">Sign In</a>
                        </p>
                    </form>
