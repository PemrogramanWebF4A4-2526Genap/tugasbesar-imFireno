<aside class="w-64 bg-white border-r border-gray-200 fixed h-full">
    ...
    <nav class="p-4 space-y-1">
        ...
        <a wire:navigate href="{{ route('seller.service.index') }}"
           class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors @yield('MenuActiveService')">
        ...
        <a wire:navigate href="#"
           class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors @yield('MenuActivePengaturan')">
    ...
    <div class="absolute bottom-0 left-0 w-64 p-4 border-t border-gray-100">
        <form action="/logout" method="POST">
            @csrf
            <button type="submit" class="flex items-center gap-3 px-4 py-3 w-full rounded-lg text-red-500 hover:bg-red-50 transition-colors">
